...
def convert_to_coco_format(pose_entries, all_keypoints):
    ...
    for n in range(len(pose_entries)):
        ...
        # keypoints = [0] * 23 * 3
        # to_coco_map = [0, -1, 6, 8, 10, 5, 7, 9, 12, 14, 16, 22, 20, 21, 11, 13, 15, 19, 17, 18, 2, 1, 4, 3]
        to_coco_map = [0, -1, 6, 8, 10, 5, 7, 9, 12, 14, 16, -1, -1, -1, 11, 13, 15, -1, -1, -1, 2, 1, 4, 3]
        person_score = pose_entries[n][-2]
        position_id = -1
        for keypoint_id in pose_entries[n][:-2]:
            position_id += 1
            if position_id == 1 or position_id == 11 or position_id == 12 or position_id == 13 or position_id == 17 or position_id == 18 or position_id == 19:  # no 'neck' in COCO
                continue
